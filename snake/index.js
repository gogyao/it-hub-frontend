...
let game = {
    ...
    fruitCountElement: document.querySelector('.fruit-count'),
    ...
    draw() {
        ...
        this.fruitCountElement = this.fruits.length;

        let fruitElements = document.querySelectorAll('.fruit');
        fruitElements.forEach((element) => element.classList.remove('fruit'))
    ...
    initGame() {
        let controlButtons = document.querySelectorAll('.control-button')
         ...
         controlButtons[1].addEventListener('click', () => {
            this.fruits.pop(getRandomCords())
        });
